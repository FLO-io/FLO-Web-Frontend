                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`relative flex items-center gap-2.5 px-3 py-2.5 transition-all duration-200 text-left w-full ${isActive
                            ...
                            >
                                ...
                                <Icon className={`text-base transition-colors ${isActive ? 'text-blue-600' : 'text-gray-400'}`} />
                                {tab.label}
                            </button>
                        );
                    })}
